...
public class TFIDFHtmlIndexFiles {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            CMPT456Similarity similarityCMPT456 = new CMPT456Similarity();
            iwc = iwc.setSimilarity(similarityCMPT456);
    ...
    static void indexDoc(IndexWriter writer, Path file, long lastModified) throws IOException {
        try (InputStream stream = Files.newInputStream(file)) {
            ...
            Reader readerHtml = new InputStreamReader(stream, StandardCharsets.UTF_8);


            DemoHTMLParser demoHTMLParser = new DemoHTMLParser();
            DocData docData = new DocData();
            String name = "HelloWorld";
            docData = demoHTMLParser.parse(docData, name , null, readerHtml, new TrecContentSource() );
